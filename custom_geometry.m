...
% --- Step 2: Build initial node table ---
% Pre-fill with defaults if count matches, otherwise zeros
...
% --- Step 4: Define cutting force nodes ---
...
if isempty(force_ans)
    ...
    cutting_nodes = str2num(force_ans{1}); %#ok<ST2NM>
...
% --- Step 5: Define fixed (clamped) nodes ---
fixed_ans = inputdlg( ...
...
if isempty(fixed_ans)
    ...
    fixed_nodes = str2num(fixed_ans{1}); %#ok<ST2NM>
