function [U, Sx, Sy, Sxy, Ex, Ey, Gxy] = run_FEA(ncon, X, Y, E, v, t, F, dzero, NDU)
...
% Preallocate global stiffness matrix (2 DOF per node)
K = zeros(2*n_nodes);
% Assemble stiffness
...
for i = 1:n_element
    ...
    n2 = ncon(i,2);
    n3 = ncon(i,3);
    % Map element local DOFs to global DOF indices
...
% Solve
% Apply boundary conditions and compute displacements, stresses and strains
[U, Sx, Sy, Sxy, Ex, Ey, Gxy] = post_processing(...
